...
MAXIT = DATA['MAXIT']
# TABF = DATA['TABF'][:500]
# MAXIT = np.full((20, ), 500, dtype=float)
nrnd = DATA['nrnd']
...
#     F1_100.append(TABF[100,i])
#     F1_200.append(TABF[200,i])
#     F1_500.append(TABF[500,i])
#     F2_100.append(TABF[100,nrnd+i])
#     F2_200.append(TABF[200,nrnd+i])
#     F2_500.append(TABF[500,nrnd+i])
...
fig.savefig("Results/Loss Results Adult 1000.png", dpi = 300)
# fig1.savefig("Results/BoxPlot Results Adult 1000.png", dpi = 300)

# pp = PdfPages("Results/Results Adult 1000.pdf")
